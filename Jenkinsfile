pipeline {
    ...
    parameters {
        ...
        string(name: 'TILT_SENSOR', defaultValue: 'GRAVITY', description: '')
        ...
        string(name: 'DIRECTION_MODE', defaultValue: 'DPAD', description: '')
        string(name: 'WHAMMY_DIRECTION', defaultValue: '-1', description: '')

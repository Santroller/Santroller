...
#define DEVICE_TYPE_KEYBOARD CONSOLE_TYPE == KEYBOARD_MOUSE || DEVICE_TYPE == FORTNITE_GUITAR || DEVICE_TYPE == FORTNITE_GUITAR_STRUM || DEVICE_TYPE == FORTNITE_DRUMS
#define DEVICE_TYPE_IS_GAMEPAD (!(DEVICE_TYPE_KEYBOARD))

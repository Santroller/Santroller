...
#define DEVICE_TYPE_IS_KEYBOARD (DEVICE_TYPE == KEYBOARD_MOUSE_TYPE || DEVICE_TYPE == FORTNITE_GUITAR || DEVICE_TYPE == FORTNITE_GUITAR_STRUM || DEVICE_TYPE == FORTNITE_DRUMS)

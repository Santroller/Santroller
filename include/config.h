...
#define DEVICE_TYPE_IS_INSTRUMENT (DEVICE_TYPE_IS_GAMEPAD && (DEVICE_TYPE_IS_GUITAR || DEVICE_TYPE == LIVE_GUITAR || DEVICE_TYPE_IS_DRUM || DEVICE_TYPE == DJ_HERO_TURNTABLE || DEVICE_TYPE == STAGE_KIT))
...
#if DEVICE_TYPE == GUITAR_HERO_GUITAR || DEVICE_TYPE == GUITAR_HERO_DRUMS || DEVICE_TYPE_IS_PRO
#define PS3_ID 0x06
...
#define HID_BUTTON_COUNT 13
#define HID_AXIS_COUNT 3
#elif DEVICE_TYPE == ROCK_BAND_PRO_DRUMS

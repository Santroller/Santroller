...
#define DEVICE_TYPE_IS_GUITAR (DEVICE_TYPE == ROCK_BAND_GUITAR || DEVICE_TYPE == GUITAR_HERO_GUITAR || DEVICE_TYPE == GUITAR_PRAISE_GUITAR)
...
#define DEVICE_TYPE_IS_KEYBOARD (CONSOLE_TYPE == KEYBOARD_MOUSE || DEVICE_TYPE == FORTNITE_GUITAR || DEVICE_TYPE == FORTNITE_GUITAR_STRUM || DEVICE_TYPE == FORTNITE_DRUMS)

...
// Remap GH midi notes to RB counterparts
#define GH_REM_MIDI_NOTE_KICK RB_MIDI_NOTE_KICK
#define GH_REM_MIDI_NOTE_RED RB_MIDI_NOTE_RED
#define GH_REM_MIDI_NOTE_GREEN RB_MIDI_NOTE_GREEN
#define GH_REM_MIDI_NOTE_YELLOW RB_MIDI_NOTE_YELLOW_CYMBAL
#define GH_REM_MIDI_NOTE_BLUE RB_MIDI_NOTE_GREEN
#define GH_REM_MIDI_NOTE_ORANGE RB_MIDI_NOTE_BLUE_CYMBAL

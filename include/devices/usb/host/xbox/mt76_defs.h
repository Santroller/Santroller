/* MT76 Register Definitions */
/* Adapted from xone driver for embedded use */
/* Original: https://github.com/medusalix/xone */
...
#define XONE_MT_CLIENT_CHANGE_CHAN_REQ 0x03
#define XONE_MT_CLIENT_CHANGE_CHAN_RESP 0x04
#define XONE_MT_CLIENT_STATISTICS_REQ 0x05
#define XONE_MT_CLIENT_STATISTICS_RESP 0x06
#define XONE_MT_CLIENT_SCAN_CHAN_REQ 0x07
#define XONE_MT_CLIENT_SCAN_CHAN_RESP 0x08
...
enum mt76_channel_band {
	MT_CHANNEL_BAND_2G = 0,
	MT_CHANNEL_BAND_5G = 1,
};
...
enum mt76_mcu_cmd {
	...
	MT_CMD_GET_CHANNEL_POWER = 0x1C,
	MT_CMD_SET_CHANNEL_CANDIDATES = 0x1D,
};

...
// clang-format off
// include/emulation/bt/bt_profile.h generated from src/emulation/bt/bt.gatt for BTstack
// it needs to be regenerated when the .gatt file is updated. 

// To generate include/emulation/bt/bt_profile.h:
...
static const uint8_t profile_data[] =
{
    ...
    // 0x0003 VALUE CHARACTERISTIC-GAP_DEVICE_NAME - READ -'SantrollerBT'
    // READ_ANYBODY
    0x14, 0x00, 0x02, 0x00, 0x03, 0x00, 0x00, 0x2a, 0x53, 0x61, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x42, 0x54, 
    // add Battery Service
    ...
    // 0x0024 REPORT_REFERENCE-READ-1-2
    0x0a, 0x00, 0x02, 0x00, 0x24, 0x00, 0x08, 0x29, 0x1, 0x2, 
    // 0x0025 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_REPORT_MAP - DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x25, 0x00, 0x03, 0x28, 0x02, 0x26, 0x00, 0x4b, 0x2a, 
    // 0x0026 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_REPORT_MAP - DYNAMIC | READ
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x26, 0x00, 0x4b, 0x2a, 
    // 0x0027 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT - DYNAMIC | READ | WRITE | NOTIFY
    0x0d, 0x00, 0x02, 0x00, 0x27, 0x00, 0x03, 0x28, 0x1a, 0x28, 0x00, 0x22, 0x2a, 
    // 0x0028 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT - DYNAMIC | READ | WRITE | NOTIFY
    // READ_ANYBODY, WRITE_ANYBODY
    ...
    // 0x002a CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_OUTPUT_REPORT - DYNAMIC | READ | WRITE | WRITE_WITHOUT_RESPONSE
    0x0d, 0x00, 0x02, 0x00, 0x2a, 0x00, 0x03, 0x28, 0x0e, 0x2b, 0x00, 0x32, 0x2a, 
    // 0x002b VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_OUTPUT_REPORT - DYNAMIC | READ | WRITE | WRITE_WITHOUT_RESPONSE
    // READ_ANYBODY, WRITE_ANYBODY
    0x08, 0x00, 0x0e, 0x01, 0x2b, 0x00, 0x32, 0x2a, 
    // 0x002c CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT - DYNAMIC | READ | WRITE | NOTIFY
    0x0d, 0x00, 0x02, 0x00, 0x2c, 0x00, 0x03, 0x28, 0x1a, 0x2d, 0x00, 0x33, 0x2a, 
    // 0x002d VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT - DYNAMIC | READ | WRITE | NOTIFY
    // READ_ANYBODY, WRITE_ANYBODY
    ...
    // 0x002f CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HID_INFORMATION - READ
    0x0d, 0x00, 0x02, 0x00, 0x2f, 0x00, 0x03, 0x28, 0x02, 0x30, 0x00, 0x4a, 0x2a, 
    // 0x0030 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HID_INFORMATION - READ -'01 01 00 02'
    // READ_ANYBODY
    0x0c, 0x00, 0x02, 0x00, 0x30, 0x00, 0x4a, 0x2a, 0x01, 0x01, 0x00, 0x02, 
    // 0x0031 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HID_CONTROL_POINT - DYNAMIC | WRITE_WITHOUT_RESPONSE
    0x0d, 0x00, 0x02, 0x00, 0x31, 0x00, 0x03, 0x28, 0x04, 0x32, 0x00, 0x4c, 0x2a, 
    // 0x0032 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HID_CONTROL_POINT - DYNAMIC | WRITE_WITHOUT_RESPONSE
    // WRITE_ANYBODY
    ...
    // 0x0034 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_REPORT - DYNAMIC | READ | WRITE | NOTIFY | ENCRYPTION_KEY_SIZE_16
    // READ_ENCRYPTED, WRITE_ENCRYPTED, ENCRYPTION_KEY_SIZE=16
    ...
    // SantrollerCapabilities, type = Input (1)
    // 0x0036 REPORT_REFERENCE-READ-10-1
    0x0a, 0x00, 0x02, 0x00, 0x36, 0x00, 0x08, 0x29, 0x10, 0x1, 
    // 0x0037 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_REPORT - DYNAMIC | READ | WRITE | WRITE_WITHOUT_RESPONSE | ENCRYPTION_KEY_SIZE_16
    0x0d, 0x00, 0x02, 0x00, 0x37, 0x00, 0x03, 0x28, 0x0e, 0x38, 0x00, 0x4d, 0x2a, 
    // 0x0038 VALUE CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_REPORT - DYNAMIC | READ | WRITE | WRITE_WITHOUT_RESPONSE | ENCRYPTION_KEY_SIZE_16
    // READ_ENCRYPTED, WRITE_ENCRYPTED, ENCRYPTION_KEY_SIZE=16
    0x08, 0x00, 0x0f, 0xf5, 0x38, 0x00, 0x4d, 0x2a, 
    // SantrollerCapabilities, type = Output (2)
    // 0x0039 REPORT_REFERENCE-READ-10-2
    0x0a, 0x00, 0x02, 0x00, 0x39, 0x00, 0x08, 0x29, 0x10, 0x2, 
    // 0x003a PRIMARY_SERVICE-GATT_SERVICE
    0x0a, 0x00, 0x02, 0x00, 0x3a, 0x00, 0x00, 0x28, 0x01, 0x18, 
    // 0x003b CHARACTERISTIC-GATT_DATABASE_HASH - READ
    0x0d, 0x00, 0x02, 0x00, 0x3b, 0x00, 0x03, 0x28, 0x02, 0x3c, 0x00, 0x2a, 0x2b, 
    // 0x003c VALUE CHARACTERISTIC-GATT_DATABASE_HASH - READ -''
    // READ_ANYBODY
    0x18, 0x00, 0x02, 0x00, 0x3c, 0x00, 0x2a, 0x2b, 0x6d, 0x87, 0x16, 0x12, 0x82, 0x0f, 0xac, 0x0f, 0x14, 0xac, 0xdb, 0x28, 0x4d, 0xf8, 0x00, 0xa4, 
    // END
    0x00, 0x00, 
}; // total size 351 bytes 
...
#define ATT_SERVICE_GATT_SERVICE_START_HANDLE 0x003a
#define ATT_SERVICE_GATT_SERVICE_END_HANDLE 0x003c
#define ATT_SERVICE_GATT_SERVICE_01_START_HANDLE 0x003a
#define ATT_SERVICE_GATT_SERVICE_01_END_HANDLE 0x003c
...
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_REPORT_MAP_01_VALUE_HANDLE 0x0026
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT_01_VALUE_HANDLE 0x0028
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT_01_CLIENT_CONFIGURATION_HANDLE 0x0029
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_OUTPUT_REPORT_01_VALUE_HANDLE 0x002b
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT_01_VALUE_HANDLE 0x002d
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT_01_CLIENT_CONFIGURATION_HANDLE 0x002e
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_HID_INFORMATION_01_VALUE_HANDLE 0x0030
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_HID_CONTROL_POINT_01_VALUE_HANDLE 0x0032
...
#define ATT_CHARACTERISTIC_GATT_DATABASE_HASH_01_VALUE_HANDLE 0x003c

...
{
public:
    PS2AxisInput(proto_PS2AxisInput input, std::shared_ptr<PS2Device> device, Profile* profile);
    bool tick_digital();
...
{
public:
    PS2ButtonInput(proto_PS2ButtonInput input, std::shared_ptr<PS2Device> device, Profile* profile);
    bool tick_digital();
    uint16_t tick_analog();

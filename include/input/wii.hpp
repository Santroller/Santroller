...
{
public:
    WiiAxisInput(proto_WiiAxisInput input, std::shared_ptr<WiiDevice> device, Profile* profile);
    bool tick_digital();
...
{
public:
    WiiButtonInput(proto_WiiButtonInput input, std::shared_ptr<WiiDevice> device, Profile* profile);
    bool tick_digital();
    uint16_t tick_analog();

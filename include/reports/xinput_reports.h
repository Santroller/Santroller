...
typedef struct
{
    ...
    uint8_t white2 : 1;  // white2 leftShoulder
    uint8_t white3 : 1;  // white3 rightShoulder
    uint8_t guide : 1;
    uint8_t : 1;

    uint8_t black1 : 1;  // black1 a
    uint8_t black2 : 1;  // black2 b
    uint8_t white1 : 1;  // white1 x
    uint8_t black3 : 1;  // black3 y

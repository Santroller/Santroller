...
inline uint8_t universal_report_to_ogxbox(uint8_t *data, uint8_t len, uint8_t sub_type, const USB_Host_Data_t *usb_host_data) {
    OGXboxGamepad_Data_t *dpad_report = (OGXboxGamepad_Data_t *)data;
    ...
    switch (sub_type) {
        case ROCK_BAND_GUITAR: {
            ...
            return sizeof(OGXboxRockBandGuitar_Data_t);
        }
        case GUITAR_HERO_GUITAR: {
            ...
            return sizeof(OGXboxGuitarHeroGuitar_Data_t);
        }
        case GUITAR_HERO_DRUMS: {
            ...
            return sizeof(OGXboxGuitarHeroDrums_Data_t);
        }
        case ROCK_BAND_DRUMS: {
            ...
            return sizeof(OGXboxRockBandDrums_Data_t);
        }
        case LIVE_GUITAR: {
            OGXboxGHLGuitar_Data_t *report = (OGXboxGHLGuitar_Data_t *)data;
            ...
            report->tilt = usb_host_data->tilt;
            report->whammy = (usb_host_data->whammy << 8) - 0x7fff;
            return sizeof(OGXboxGHLGuitar_Data_t);
        }
        case DJ_HERO_TURNTABLE: {
            ...
            return sizeof(OGXboxTurntable_Data_t);
        }
        case ROCK_BAND_PRO_KEYS: {
            ...
            return sizeof(OGXboxRockBandKeyboard_Data_t);
        }
        ...
        case ROCK_BAND_PRO_GUITAR_MUSTANG: {
            ...
            report->tilt = usb_host_data->tilt;
            report->kick1 = usb_host_data->kick1;
            return sizeof(OGXboxRockBandProGuitar_Data_t);
        }

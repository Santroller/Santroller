...
inline void wii_to_universal_report(const uint8_t *data, uint8_t len, uint16_t controllerType, bool hiRes, USB_Host_Data_t *usb_host_data) {
...
inline uint8_t universal_report_to_wii(uint8_t *data, uint8_t len, uint8_t sub_type, uint8_t format, const USB_Host_Data_t *usb_host_data) {
    switch (sub_type) {

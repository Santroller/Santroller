...
- Support for various consoles, including PS2/3/4/5, Wii, Switch, Xbox 360 and Xbox One / Series
  ...
  | Guitar / Drums                         | Fortnite Festival Standard Mode   |                                                                                           |                | Works natively, though you need to set the NKRO type to 6KRO                                                                      | Works natively, though you need to set the NKRO type to 6KRO                                                                      |                                                                                                                                                                                                    | Works natively                                                                                 |                                                                               | Works natively                                                                              |
  | Rock Band Guitar / Rock Band Drums     | Fortnite Festival Instrument Mode |                                                                                           |                | Requires [authentication](https://santroller.tangentmc.net/console_guides/authentication.html), set the PS4 Emulation Mode to PS4 | Requires [authentication](https://santroller.tangentmc.net/console_guides/authentication.html), set the PS4 Emulation Mode to PS4 |                                                                                                                                                                                                    | Works natively                                                                                 |                                                                               |                                                                                             |

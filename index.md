...
- Support for various consoles, including PS2/3/4/5, Wii, Switch, Xbox 360 and Xbox One / Series
  ...
  | Rock Band Guitar / Rock Band Drums     | Fortnite Festival Instrument Mode | Requires setting up a Console Mode Binding for Festival |                                                                                           |                | Requires [authentication](https://santroller.tangentmc.net/console_guides/authentication.html), set the PS4 Emulation Mode to PS4 | Requires [authentication](https://santroller.tangentmc.net/console_guides/authentication.html), set the PS4 Emulation Mode to PS4 |                                                                                                                                                                                                    | Requires [authentication](https://santroller.tangentmc.net/console_guides/authentication.html) |                                                                                                                                                                            |                                                                                             |

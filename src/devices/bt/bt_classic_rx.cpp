...
static bool check_bluetooth_ready() {
...
static void bt_set_report(const uint8_t *data, uint8_t len, uint8_t reportType, uint8_t report_id) {
...
static int bt_get_scan_results(uint8_t *buf) {
    int size = 0;

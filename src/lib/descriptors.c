...
const PROGMEM TUSB_Descriptor_Configuration_XBOX_t XBOXConfigurationDescriptor = {
    ...
    ReportINEndpoint21 : {
        Header : {Size : sizeof(XBOXConfigurationDescriptor.ReportINEndpoint21), Type : TDTYPE_Endpoint},
        EndpointAddress : ENDPOINT_IN | 3,
        Attributes : (EP_TYPE_INTERRUPT | ENDPOINT_TATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
        EndpointSize : 0x20,
        PollingIntervalMS : 2,
    },
    ReportOUTEndpoint22 : {
        Header : {Size : sizeof(XBOXConfigurationDescriptor.ReportOUTEndpoint22), Type : TDTYPE_Endpoint},
        EndpointAddress : ENDPOINT_OUT | 4,
        Attributes : (EP_TYPE_INTERRUPT | ENDPOINT_TATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
        EndpointSize : 0x20,
        PollingIntervalMS : 4,
    },
    ReportINEndpoint23 : {
        Header : {Size : sizeof(XBOXConfigurationDescriptor.ReportINEndpoint23), Type : TDTYPE_Endpoint},
        EndpointAddress : ENDPOINT_IN | 5,
        Attributes : (EP_TYPE_INTERRUPT | ENDPOINT_TATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
        EndpointSize : 0x20,
        PollingIntervalMS : 0x40,
    },
    ReportOUTEndpoint24 : {
        Header : {Size : sizeof(XBOXConfigurationDescriptor.ReportOUTEndpoint24), Type : TDTYPE_Endpoint},
        EndpointAddress : ENDPOINT_OUT | 5,
        Attributes : (EP_TYPE_INTERRUPT | ENDPOINT_TATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
        EndpointSize : 0x20,
        PollingIntervalMS : 0x10,
    },
    Interface3 : {Header : {Size : sizeof(XBOXConfigurationDescriptor.Interface3),
                            Type : TDTYPE_Interface},
                  InterfaceNumber : 2,
                  AlternateSetting : 0x00,
                  TotalEndpoints : 1,

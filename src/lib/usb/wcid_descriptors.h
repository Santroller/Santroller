...
typedef struct {
    ...
    TUSB_OSCompatibleSection_t CompatID2;
    TUSB_OSCompatibleSection_t CompatID3;
    TUSB_OSCompatibleSection_t CompatID4;
} TATTR_PACKED TUSB_OSCompatibleIDDescriptor_4_t;

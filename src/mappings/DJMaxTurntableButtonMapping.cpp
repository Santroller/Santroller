...
#include "main.hpp"
// TODO: this
DJMaxTurntableButtonMapping::DJMaxTurntableButtonMapping(proto_Mapping mapping, std::unique_ptr<Input> input, uint16_t id) : ButtonMapping(mapping, std::move(input), id)
{

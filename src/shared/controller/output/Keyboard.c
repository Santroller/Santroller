...
bool CALLBACK_HID_Device_CreateHIDReport(
  ...
  if (bit_check(keyboard_state, K_WHAMMY)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_WHAMMY;
  }
  if (bit_check(keyboard_state, UP)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_UP;
  }
  if (bit_check(keyboard_state, DOWN)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_DOWN;
  }
  if (bit_check(keyboard_state, LEFT)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_LEFT;
  }
  if (bit_check(keyboard_state, RIGHT)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_RIGHT;
  }
  if (bit_check(keyboard_state, START)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_START;
  }
  if (bit_check(keyboard_state, SELECT)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_SELECT;
  }
  if (bit_check(keyboard_state, GREEN)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_GREEN;
  }
  if (bit_check(keyboard_state, RED)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_RED;
  }
  if (bit_check(keyboard_state, YELLOW)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_YELLOW;
  }
  if (bit_check(keyboard_state, BLUE)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_BLUE;
  }
  if (bit_check(keyboard_state, ORANGE)) {
    KeyboardReport->KeyCode[UsedKeyCodes++] = KEY_ORANGE;
  }

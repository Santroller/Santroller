...
bool isXboxGuitar(void) {
  return config.sub_type == GUITAR_SUBTYPE ||
         config.sub_type == GUITAR_ALTERNATE_SUBTYPE ||
         config.sub_type == GUITAR_BASS_SUBTYPE;
}
bool isPS3Guitar(void) {
  return config.sub_type == PS3_GUITAR_SUBTYPE ||

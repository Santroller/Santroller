...
// Data that we need to send in order for the PS3 to identify our controller correctly.
const static uint8_t PROGMEM ps3_init_data[] = {0x21, 0x26, 0x01, 0x07, 0x00, 0x00, 0x00, 0x00};

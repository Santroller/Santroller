...
uint8_t universal_report_to_santroller(uint8_t dpad, uint8_t *data, uint8_t sub_type, const USB_Host_Data_t *usb_host_data) {
    PCGamepad_Data_t *report = (PCGamepad_Data_t *)data;
    report->dpad = dpad;
        ...
        case ROCK_BAND_DRUMS: {
            ...
            if (usb_host_data->greenVelocity) {
                if (usb_host_data->greenCymbalVelocity) {
                    report->greenVelocity = usb_host_data->greenCymbalVelocity;
                } else {
            ...
            if (usb_host_data->yellowVelocity) {
                if (usb_host_data->yellowCymbalVelocity) {
                    report->yellowVelocity = usb_host_data->yellowCymbalVelocity;
                } else {
            ...
            if (usb_host_data->blueVelocity) {
                if (usb_host_data->blueCymbalVelocity) {
                    report->blueVelocity = usb_host_data->blueCymbalVelocity;
                } else {

...
const PROGMEM STRING_DESCRIPTOR rtStringLED = USB_DESCRIPTOR_STRING_UTF("RT-GH LED ");
const PROGMEM STRING_DESCRIPTOR rtStringInput = USB_DESCRIPTOR_STRING_UTF("RT-GH INPUT ");

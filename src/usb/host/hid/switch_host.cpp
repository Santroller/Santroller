...
{
    // TODO: theres quite a bit to do here, can we detect switch controllers by their HID reports?
...
bool SwitchHost::tick_digital(UsbButtonType type)
{
    return false;
}
uint16_t SwitchHost::tick_analog(UsbAxisType type)
{
    return 0;
}
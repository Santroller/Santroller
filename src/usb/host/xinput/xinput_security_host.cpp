...
{
    TU_VERIFY(TUSB_CLASS_VENDOR_SPECIFIC == desc_itf->bInterfaceClass && desc_itf->bInterfaceSubClass == 0xfD &&
    ...
    TU_VERIFY(XINPUT_SECURITY_DESC_TYPE_RESERVED == x_desc->bDescriptorType, nullptr);

...
1. Connect the following pins using the image below as a guide
   ...
   2. Connect the analog pin to a digital pin on the Pi Pico. You will need to solder directly to the chip on the PCB. While the pin is an analog signal, due to how this type of touch sensor works, you can connect it to a digital pin as we only read a digital signal from it
   3. connect a 1Mohm resistor between the analog pin and ground
